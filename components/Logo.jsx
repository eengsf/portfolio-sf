const Logo = ({ name, size, color }) => {
  switch (name) {
    ...
    case 'instagram':
      ...
      let color2 = 'black';
      if (color === 'yes') {
        color1 = 'url(#yOrnnhliCrdS2gy~4tD8ma_Xy10Jcu1L2Su_gr1)';
        color2 = 'url(#yOrnnhliCrdS2gy~4tD8mb_Xy10Jcu1L2Su_gr2)';
      } else if (color === 'no') {
        color1 = 'black';
        color2 = 'black';
      }
      ...
      return (
        ...
        >
          <linearGradient
            ...
            gradientUnits="userSpaceOnUse"
          >
            <stop offset="0" stop-color="#00b3ba"></stop>
            <stop offset=".998" stop-color="#00979c"></stop>
          </linearGradient>
          <path
    ...
    case 'Shadcn UI':
      return (
        <svg
          ...
          viewBox="0 0 48 48"
        >
          <rect width="36" height="36" x="6" y="6" fill="black" />
          <path
            fill="none"
            stroke="white"
            strokeWidth="2"
            d="M34 26l-10 10M32 10L10 32"
          />
        </svg>
      );
      break;
